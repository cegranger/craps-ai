...
def _load_graphics():
    ...
    button sheet.
    """
    gfx = tools.load_all_gfx(os.path.join("craps/resources", "graphics"))
    _get_cards(gfx)
...
FONTS = tools.load_all_fonts(os.path.join("craps/resources", "fonts"))
# MUSIC = tools.load_all_music(os.path.join("craps/resources", "music"))
# SFX   = tools.load_all_sfx(os.path.join("craps/resources", "sound"))
GFX   = _load_graphics()
